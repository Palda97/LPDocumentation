Requirements engineering is a process to determine things, the desired system will consist of. This process itself consists of three stages. \todo[inline]{opět - nepopisujte, co je req. eng. ale napište, co je v této části práce uděláno, a jak.}

\section{Elicitation}
The first faze \todo[inline]{phase. Nechte si text nakonec opravit} of requirements engineering is elicitation. It's the faze of gathering information.
